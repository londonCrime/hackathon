...
crosslet.MapView = (function(_super) {
  ...
  MapView.prototype.initialize = function(el, config) {
    ...
    // L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', this.config.map.leaflet).addTo(this.map);
    ...
    return this.ds.loadGeo(this.geoURL, this.config.map.geo.id_field, function(ds) {
      ...
      _this.hoverElementRect = _this.hoverElement.append("svg:rect")
                                                 .attr("x", 0)
                                                 .attr("y", 0)
                                                 .attr("width", 10)
                                                 .attr("height", 30)
                                                 .attr("rx", 5)
                                                 .attr("ry", 5);
      _this.hoverElementText = _this.hoverElement.append("text")
                                                 .attr("x", 0)
                                                 .attr("y", 0);
  ...
  MapView.prototype.hover = function(data) {
    ...
    return this.hoverElementRect.attr("width", this.hoverElementTextBB.width + 10)
                                .attr("height", this.hoverElementTextBB.height + 10)
                                .attr("x", this.hoverElementTextBB.x - 5)
                                .attr("y", this.hoverElementTextBB.y - 5);
  };
